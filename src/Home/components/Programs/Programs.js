...
export const Programs = () => {
    return (
        ...
        <div className="container bg-light mt-3 mb-3 pt-3 pb-3">
            <div className="page-header">

                <h3><strong>IIT Indore offers following Academic Programs</strong></h3>
            </div>
            ...
            <table className="table table-hover">
                <thead>
                    <tr>
                        <th>1. Bachelor of Technology (BTech)   </th>
                    </tr>
                </thead>
            ...
            <table className="table table-hover">
                <thead>
                    <tr>
                        <th>2. Master of Technology (MTech) with provision of converting to MTech + PhD dual degree at the end of 3rd Semester </th>
                    </tr>
                </thead>
            ...
            <table className="table table-hover">
                <thead>
                    <tr>
                        <th>3. Two-year Master of Science (MSc) with provision of converting to MSc + PhD dual degree at the end of 3rd Semester </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;3.5 <font color="blue">Astronomy</font> <font color="green">(from AY 2018-19)</font>
                        </td>
                    </tr>
            ...
            <table className="table table-hover">
                <thead>
                    <tr>
                        <th>4. Five-year BTech + MTech (only for eligible BTech students of IIT Indore at the end of 6th semester) </th>
                    </tr>
                </thead>
            ...
            <table className="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.10 <font color="blue">English</font> <font color="green">(from AY 2011-12)</font>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.11 <font color="blue">Philosophy</font> <font color="green">(from AY 2010-11)</font>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.12 <font color="blue">Economics</font> <font color="green">(from AY 2010-11)</font>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.13 <font color="blue">Psychology</font> <font color="green">(from AY 2012-13)</font>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.14 <font color="blue">Sociology</font> <font color="green">(from AY 2013-14)</font>
                    ...
                    <tr>
                        <td>
                            &nbsp;&nbsp;6.15 <font color="blue">Astronomy, Astrophysics and Space Engineering</font> <font color="green">(from AY 2016-17)</font>
