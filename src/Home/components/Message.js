                ...
                <div className="container-fluid pb-5">
                    <div className="card-group ">
                        ...
                        <div className="card bg-light col-sm-12 border-0">
                            <h1 className="p-2 pl-5 pt-5 pr-5 mainTitle" style={{ margin: 'auto' }} >Message From The Dean</h1>
                            <img src={image} className="img-thumbnail" alt="img-responsive" style={{ width: '25%', margin: 'auto' }} />
