...
export const Ghouse = () => {
	return (
		<div className="container font-ubuntu aboutIITI pb-5">
			...
			<img src={gh} style={{ width: "100%" }} className="mb-5" />
			<p>
				As per institute accommodation policy the IIT Indore Guest House accommodation
				charges are divided into two categories that are Category "A" and Category "B".
			</p>
			...
			<p>
				<strong>Note</strong> - Presently we are having only one category of room that is
				Executive AC Room. Above mentioned charges are applicable for both domestic and
			...
			<p>
				Contact details are as follows for reservation of accommodation at IIT Indore Guest
				House -
			</p>
			<p>
