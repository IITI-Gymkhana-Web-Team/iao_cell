                ...
                <div class="col-smm-12 col-lg-8">
                    <div class="news container bg-light mt-5" >
                        <div class='container-fluid'>
                            <h2 className="p-2 pl-5 pt-5 pr-5 mainTitle">Research</h2>
                        </div>
                        <div class='container-fluid' style={{ maxWidth: '1140px' }} >
                            ...
                            >
                                ...
                                {/* <div ><Newsutil text={text} title={title} /></div>
                                <div><Newsutil text={text} title={title} /></div>
                                <div><Newsutil text={text} title={title} /></div>
                                <div><Newsutil text={text} title={title} /></div>
                                <div><Newsutil text={text} title={title} /></div>
                    ...
                    <div class="news container bg-light mt-5" >
                        <div >
                            ...
                            <div style={{ margin: 'auto', maxWidth: '400px' }} >
                                ...
                                >
                                    <div><Announceutil text={text} title={title} /></div>
                                    <div><Announceutil text={text} title={title} /></div>
                                    <div><Announceutil text={text} title={title} /></div>
                                    <div><Announceutil text={text} title={title} /></div>
                                    <div><Announceutil text={text} title={title} /></div>
                            ...
                            <div style={{ margin: 'auto', maxWidth: '400px' }} >
                                ...
                                >
                                    <div ><Talkutil text={text} title={title} /></div>
                                    <div><Talkutil text={text} title={title} /></div>
                                    <div><Talkutil text={text} title={title} /></div>
                                    <div><Talkutil text={text} title={title} /></div>
                                    <div><Talkutil text={text} title={title} /></div>
